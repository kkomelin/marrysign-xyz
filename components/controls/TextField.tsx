  ...
  return (
    <div className={c('my-2 field', { required: required })}>
      ...
      <input
        ...
        name={id}
        disabled={disabled}
        className="block w-full px-3 py-3 border rounded-md shadow-sm placeholder-input border-accent focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
